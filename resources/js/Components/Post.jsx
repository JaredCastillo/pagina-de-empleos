    ...
    <div className="p-5 flex space-x-2">
          ...
          <div className='flex-1'>
                ...
                { editing
                    ...
                    : (
                        <>
                            <p className='mt-4 text-lg text-gray-300'>{post.title}</p>
                            <p className='mt-4 text-lg text-white'>{post.salary}</p>
                            <p className='mt-4 text-white'>{post.body}</p>
                            <p className='mt-4 text-gray-900'>{post.requirements}</p>
                        </>
                    )
                }
